...
export class FileOrganizer implements IFileOrganizer {
  ...
  private detectFileType(fileName: string, file: CodeGenerationResult): string {
    ...
    if (lowerFileName.includes('style') || lowerFileName.endsWith('.css') || 
        lowerFileName.endsWith('.scss') || lowerFileName.endsWith('.less')) {
      return 'styles';
    }
  ...
  private isComponentFile(file: CodeGenerationResult): boolean {
    ...
    // React patterns
    if (code.includes('react.component') || 
    ...
    // Vue patterns
    if (code.includes('vue.component') || 
    ...
    if (code.includes('@component') || 
        code.includes('angular.component')) {
      return true;
    }

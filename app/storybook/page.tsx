...
// Note: CodeBlock is defined but not currently used in this component.
// It's available for future code display functionality.
...
function ComponentDocSection({ component }: { component: ComponentDocumentation }) {
    ...
    switch (componentName) {
      ...
      case 'Card':
        switch (exampleTitle) {
          case 'Basic Card':
            return (
              <Card className="max-w-sm" variant="flat">
                <CardHeader>
  ...
  return (
    <Card className="mb-8" id={component.name.toLowerCase()} variant="flat">
      <CardHeader>
            ...
            <section className="mb-16">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-neutral-600 max-w-3xl mx-auto mb-8">
                  Interactive component library showcasing all Willow Design System components with live examples, 
                  documentation, and code snippets. Built with React, TypeScript, and Tailwind CSS.
                </p>
    ...
    <AppLayout>
      <div className="flex min-h-screen bg-neutral-50">
        ...
        <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-white border-r border-neutral-200 overflow-y-auto z-40">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-4">Storybook</h3>
